        ...
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" style="width:80px;" required name="systolic" id="systolic" value="{{ old('systolic') }}">
                ...
                <div class="form-group">
                    ...
                    <input type="number" class="form-control" style="width:80px;" required name="diastolic" id="diastolic" value="{{ old('diastolic') }}">
